  ...
  <div class="text-gray-900 text-sm">
    ...
    <div class="container mx-auto my-8 px-4 flex">
      <div class="file-explorer-container w-3/4 mr-8">
        <div class="branch-navigation flex items-center justify-between">
          <div class="flex items-center space-x-3">
            ...
            <a href="#" class="flex items-center space-x-2 py-1 group">
          ...
          <div class="flex items-center space-x-2">
            ...
            <button class="font-semibold border border-gray-400 rounded-md text-white bg-green-600 hover:bg-green-700 px-4 py-1 flex items-center space-x-2">
              <svg class="w-4 fill-current text-gray-200" viewBox="0 0 16 16" aria-hidden="true"><path fill-rule="evenodd" d="M7.47 10.78a.75.75 0 001.06 0l3.75-3.75a.75.75 0 00-1.06-1.06L8.75 8.44V1.75a.75.75 0 00-1.5 0v6.69L4.78 5.97a.75.75 0 00-1.06 1.06l3.75 3.75zM3.75 13a.75.75 0 000 1.5h8.5a.75.75 0 000-1.5h-8.5z"></path></svg>
              <div>Code</div>
              <svg class="w-3 ml-1" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M19 9l-7 7-7-7"></path></svg>
            </button>
          </div>
        ...
        <div class="commits-container bg-blue-100 rounded-md rounded-b-none border border-blue-200 border-b-0 flex items-center justify-between px-4 py-4 mt-5">
          ...
          <div class="flex items-end">
            ...
            <a href="#" class="flex items-center ml-3">
              ...
              <span class="ml-1"><span class="font-semibold">3,040</span> commits</span>
            </a>
          </div>
        ...
        <div class="file-explorer rounded-md rounded-t-none border border-gray-400 text-gray-700 divide-y divide-gray-400">
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate"><a href="#" class="hover:underline hover:text-blue-600 truncate">Add new `plugin` and `plugin.withOptions` functions for creating plugins</a></div>
      ...
      <div class="sidebar w-1/4">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente obcaecati porro sit possimus explicabo debitis culpa similique, veritatis ex animi amet maxime autem? Facere vel vitae illo facilis? Quae autem, ea nihil suscipit quas, porro quod veniam doloribus saepe voluptatibus ducimus quibusdam incidunt corporis quia consequatur! Eveniet ut hic accusamus? Sed fuga totam inventore unde voluptatum, ipsa atque hic enim? Maiores quae cupiditate labore molestiae vel! Enim porro impedit, consectetur sint maiores atque cupiditate obcaecati nihil asperiores in, provident veritatis? Quaerat perferendis unde recusandae quos tempora esse explicabo dicta! Aperiam quas, labore doloremque inventore autem pariatur ullam eius optio blanditiis.
      </div> <!-- end sidebar -->
    </div>
